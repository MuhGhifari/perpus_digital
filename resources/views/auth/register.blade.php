      ...
      <div class="col-5 col-sm-3 position-relative urbanist-semibold" style="margin-top: 50px;width: 60%; color: black;">
        <div class="position-absolute top-50 start-50 translate-middle" style="width: 70%; padding: 50px;">
          <div style="display: grid;" class="text-center">
            ...
            <span class="amaranth-regular" style="color: black; font-size: 32px;">di <span class="amaranth-regular"
                style="color: #6499E9;">Perpustakaan Digital</span> Universitas Pakuan</span>
              ...
              <div class="col">
                ...
                <div class="input-group">
                  <input type="password" name="password_confirmation" required class="form-control"
                    placeholder="Masukkan Konfirmasi Kata Sandi" id="confirmation" aria-describedby="password-input">
                </div>
              </div>
            </div>

            <button class="w-100 btn btn-primary" style="margin-top: 36px; background-color: #6499E9;">Daftar</button>

            <div style="margin-top: 36px;" class="text-center">
              <span>Sudah punya akun? <a style="color: #1746A2; text-decoration: none;" href="{{ route('login') }}">Masuk
                  Sekarang</a></span>
            </div>
          </form>
        </div>
